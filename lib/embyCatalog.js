    ...
    try {
        ...
        const response = await axios({
            ...
            params: {
                ...
                Recursive: true,
                Fields: 'ProviderIds,Overview,PremiereDate,CommunityRating,OfficialRating,Genres,Path,ParentId',
                SortBy: 'DateCreated',
        ...
        const filteredItems = items.filter(item => {
            ...
            // Exclude items with IndexNumber that also have a parent (episodes have index numbers)
            if (item.IndexNumber !== undefined && item.IndexNumber !== null) {
                // If it has an index number and a parent, it's likely an episode
